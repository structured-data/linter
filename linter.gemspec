...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency      'puma',               '~> 3.9'
  gem.add_runtime_dependency      'rack-cache',         '~> 1.7'
  ...
  gem.add_runtime_dependency      'sinatra-linkeddata', '~> 2.2'
  gem.add_runtime_dependency      'sinatra-asset-pipeline', '~> 1.0', '>= 1.0.2'
